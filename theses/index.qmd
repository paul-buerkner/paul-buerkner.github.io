...
- Literature review of different inducing point based methods
- Implementing the corresponding models in Stan
- Running a simulation study to compare the different methods
- Applications on a real case study if sensible
:::
...
1. Literature search on initial value problems and methods
