...
- Ghosh, A., et al. (2022). GaMPEN: a machine-learning framework for estimating Bayesian posteriors of galaxy morphological parameters. *The Astrophysical Journal*.
- Ghosh, A., et al. (2023). Morphological Parameters and Associated Uncertainties for 8 Million Galaxies in the Hyper Suprime-Cam Wide Survey. *The Astrophysical Journal*.
...
- Radev, S. T., et al. (2020). BayesFlow: Learning complex stochastic models with invertible neural networks. *IEEE Transactions on Neural Networks and Learning Systems*.
- Radev, S. T., et al. (2023). JANA: Jointly amortized neural approximation of complex Bayesian models. *Uncertainty in Artificial Intelligence*.
...
- Nalborczyk, L. & Bürkner, P. (2025). Precise temporal localisation of M/EEG effects with Bayesian generalised additive multilevel models. *bioRxiv preprint*.
