...
## Estimating Morphological Parameters of Galaxies with Amortized Bayesian Inference

**Supervision**: 
[Aayush Mishra](../people#aayush-mishra){.btn .btn-outline-primary .btn role="button" .btn-page-header .btn-xs}

**Project**: [Semi-Supervised Learning for Robust Amortized Bayesian Inference](../projects#semi-supervised-abi){.btn .btn-outline-primary .btn role="button" .btn-page-header .btn-xs}

**Relevant literature**: 

- [GaMPEN: a machine-learning framework for estimating Bayesian posteriors of galaxy morphological parameters](https://iopscience.iop.org/article/10.3847/1538-4357/ac7f9e/pdf)
- [Morphological Parameters and Associated Uncertainties for 8 Million Galaxies in the Hyper Suprime-Cam Wide Survey](https://iopscience.iop.org/article/10.3847/1538-4357/acd546/pdf)
- [The frontier of simulation-based inference](https://www.pnas.org/doi/pdf/10.1073/pnas.1912789117)
- [BayesFlow 2.0: Multi-Backend Amortized Bayesian Inference in Python](https://arxiv.org/abs/2602.07098)
- [JANA: Jointly Amortized Neural Approximation of Complex Bayesian Models](https://arxiv.org/abs/2302.09125)


**Tools**: Python, BayesFlow

**Problem description**:
Estimating the morphology of galaxies at different redshifts is crucial to understand galaxy formation and evolution. Traditional methods of morphology estimation such as visual classification and template fitting are not scalable to large data volumes from modern surveys and telescopes such as James Webb and The Vera Rubin observatory. Deep learning-based approaches have so far focused on morphology classification and not estimating the posterior distribution of the parameters. While Bayesian ML approaches using Monte Carlo dropout have been applied to overcome this research gap, these methods do not fully leverage modern generative neural posterior estimation and amortized Bayesian inference techniques.

**Project structure**: 

- Literature review of existing studies on galaxy morphology and ABI
- Design and optimize a forward simulation pipeline capable of generating realistic galaxy images across a range of redshifts, morphologies, and observing conditions. The pipeline will incorporate instrument-specific effects (e.g., PSF, noise characteristics, pixel scale) for multiple telescopes and bands, enabling controlled generation of labeled training data for amortized inference
- Acquire real galaxy imaging data and associated redshift information from public archives, including JWST datasets. Data preprocessing and cross-matching with redshift catalogs will be performed to ensure consistency with the simulated training data
- Train flow-based neural posterior estimation models to learn the conditional posterior distribution of galaxy morphological parameters given imaging data
- Perform inference on real images and benchmark against existing methods
...
- [Normalizing flows: An introduction and review of current methods](https://www.jmlr.org/papers/volume22/19-1028/19-1028.pdf)
...
::: {.callout-note icon=false collapse="true"}
## Multilevel Bayesian modelling of spatio-temporal M/EEG data

**Supervision**: 
[Paul Bürkner](../people#paul-buerkner){.btn .btn-outline-primary .btn role="button" .btn-page-header .btn-xs}

**Collaborator**:
[Ladislas Nalborczyk](https://lnalborczyk.github.io/){.btn .btn-outline-primary .btn role="button" .btn-page-header .btn-xs}

**Relevant literature**: 

- [Precise temporal localisation of M/EEG effects with Bayesian generalised additive multilevel models](https://www.biorxiv.org/content/10.1101/2025.08.29.672336v1)

**Tools**: R, Python, Stan

**Problem description**: Recent work has shown that Bayesian Generalised Additive Multilevel Models (BGAMMs) provide a powerful and principled alternative to cluster-based permutation tests for analysing M/EEG data, as they naturally account for temporal dependencies, yield smooth time courses of effects, and allow both participant- and group-level inference. The goal of this internship is to extend this modelling framework to the spatiotemporal domain by incorporating sensor-level structure (e.g., adjacency matrices, spatial bases, covariance kernels) into the multilevel Bayesian model. A central challenge is to design a method that remains computationally efficient, scalable to high-dimensional M/EEG datasets, and compatible with practical workflows in MNE-Python and R. The student will work on model development, simulation studies, and empirical applications (all in R) using empirical M/EEG datasets.

**Project structure**: 

- Reviewing statistical approaches for modelling temporal and spatial dependencies in M/EEG data
- Developing a computationally-efficient spatiotemporal Bayesian GAMM (e.g., tensor-product smooths, sparse or low-rank spatial bases, adjacency-informed priors) in R
- Running extensive simulation studies to assess recoverability, speed, and accuracy
- Applying the model to empirical M/EEG data and comparing it with classical permutation-based statistics
- Writing the thesis and documenting the modelling framework in the neurogam package (https://lnalborczyk.github.io/neurogam/)
:::
