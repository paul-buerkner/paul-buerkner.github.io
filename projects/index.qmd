...
[Holger Olischläger](../people#holger-olischlaeger){.btn .btn-outline-primary .btn role="button" .btn-page-header .btn-xs}
...
#| echo: false
#| output: asis
render_publications(project = "bayesflow-sim-intelligence", author = "Kühmichel, L.")
```
