...
- Radev S. T., Schmitt M., Schumacher L., Elsemüller L., Pratz V., Schälte Y., Köthe U., & Bürkner P. C. (2023). [BayesFlow: Amortized Bayesian Workflows With Neural Networks](https://joss.theoj.org/papers/10.21105/joss.05702). *Journal of Open Source Software*. Available for free also on [ArXiv](https://arxiv.org/abs/2306.16015). doi:10.21105/joss.05702
...
- Elsemüller L., Olischläger H., Schmitt M., Bürkner P. C., Köthe U., Radev S.T. (2023). [Sensitivity-Aware Amortized Bayesian Inference](https://arxiv.org/abs/2310.11122). *ArXiv preprint*.
