...
* **Bürkner P. C.**, Gabry J., & Vehtari A. (in press). [Approximate leave-future-out cross-validation for time series  models](https://arxiv.org/abs/1902.06281). *Journal of Statistical Computation and Simulation*.
